...
public class GLMUtils {
  ...
  public static TwoDimTable combineTableContents(final TwoDimTable glmSc1, final TwoDimTable earlyStopSc2,
    ...
    int glmRowIndex = 0;
    int rowIndex = 0;
    List<Integer> iterRecorded = new ArrayList<Integer>();
    ...
    for (int index = sc2RowIndex; index < rowSize; index++) { // add left over scoring history
